  ...
  return (
    <View style={styles.container}>
      ...
      <Text h5 style={styles.textBody}>
        Nous vous avons envoyé un lien de confirmation de votre abonnement sur
        votre adresse email.
      </Text>

      <View style={{ justifyContent: "center", alignItems: "center" }}>
        <View style={styles.image}>
          <Image source={require("../assets/check-mail.png")} />
        </View>
      </View>
...
export default connect(mapStateToProps,null)(SubscriptionValidation);
