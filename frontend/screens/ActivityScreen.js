...
function App(props) {
  ...
  async function getEvents() {
    ...
    console.log("L125 getEvent", getEvents);
  ...
  let filterMarkers = (type) => {
    ...
    console.log("L261 newArr", newArr);
  ...
  let filterSelectedEventsByDate = (date) => {
    ...
    if (tagName !== null) {
      ...
      console.log("L275 selectedEventsByDate", selectedEventsByDate);
    } else {
      ...
      console.log("selectedEventsByDate", selectedEventsByDate);
    }
  };
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                    if (pressedEvent === elt.titre) {
                      ...
                      setTimeout(() => refRBSheet.current.open(), 2200);
                      console.log("scrollto:", refScrollViewYAxis[i]);
                      setTimeout(
                        () =>
                      ...
                      // console.log(refScrollViewEvent.current)
                      // setTimeout(()=>refScrollViewEvent.current.scrollToEnd(),2000)
                    }
                  }}
                  onLayout={(event) => {
