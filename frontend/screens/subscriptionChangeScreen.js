...
function subscriptionChange(props) {
  ...
  var handlepress = (number) => {
    setColorCard(number);
    setTimeout(() => refScrollView.current.scrollToEnd({ animated: true }), 300);
  };
      ...
      return (
        <View style={styles.viewButton}>
          <Button
            ...
            title="Choisir"
            titleStyle={{ fontFamily: "BowlbyOne-Regular", fontSize: 20 }}
            onPress={() => {props.navigation.navigate("Approfondir")}}
          />
        </View>
      );
    }
          ...
          >
            <Card style={flanerSub}>
              <View style={styles.view}>
                <View>
                  <Text h4 style={colorCard === 1 ? [styles.textTitleCard,{color:'white'}] : styles.textTitleCard}>
                    Flâner
                  </Text>
                  <Text //Forcer à deux lignes avec le numberOfLine, si la longeur de la ligne dépasse ... s'afficheront grace au ellipsizeMode
                    style={colorCard === 1 ? [styles.paragraph,{color:'white'}] : styles.paragraph}
                    numberOfLines={1}
                    ellipsizeMode="tail"
                  >
                    9,90€/mois
                  ...
                  <Text
                    style={colorCard === 1 ? [styles.paragraph2,{color:'white'}] : styles.paragraph2}
                    numberOfLines={1}
                    ellipsizeMode="tail"
                  >
...
>
  ...
  <Card style={explorerSub}>
    <View style={styles.view}>
      <View>
        <Text h4 style={colorCard === 2 ? [styles.textTitleCard,{color:'white'}] : styles.textTitleCard}>
          Explorer
        </Text>
        <Text //Forcer à deux lignes avec le numberOfLine, si la longeur de la ligne dépasse ... s'afficheront grace au ellipsizeMode
          style={colorCard === 2 ? [styles.paragraph,{color:'white'}] : styles.paragraph}
          numberOfLines={1}
          ellipsizeMode="tail"
        >
          19,90€/mois
        ...
        <Text
          style={colorCard === 2 ? [styles.paragraph2,{color:'white'}] : styles.paragraph2}
          numberOfLines={1}
          ellipsizeMode="tail"
        >
...
var MySubscriptonIsApprofondir =  <TouchableOpacity //Rendre la Card Clickable
onPress={() => handlepress(3)}
>
<Card style={appronfSub}>
  <View style={styles.view}>
    <View>
      <Text h4 style={colorCard === 3 ? [styles.textTitleCard,{color:'white'}] : styles.textTitleCard}>
        Approfondir
      </Text>
      <Text //Forcer à deux lignes avec le numberOfLine, si la longeur de la ligne dépasse ... s'afficheront grace au ellipsizeMode
        style={colorCard === 3 ? [styles.paragraph,{color:'white'}] : styles.paragraph}
        numberOfLines={1}
        ellipsizeMode="tail"
      >
        39,90€/mois
      ...
      <Text
        style={colorCard === 3 ? [styles.paragraph2,{color:'white'}] : styles.paragraph2}
        numberOfLines={1}
        ellipsizeMode="tail"
      >
...
var showSubscriptionIdontHaveCase1;
var showSubscriptionIdontHaveCase2;

// Faire apparaitre uniquement les abonnements que je n'ai pas actuellement
  switch(props.user.subscriptionName){
    case "Flâner":
      showSubscriptionIdontHaveCase1 =  MySubscriptonIsApprofondir  
      showSubscriptionIdontHaveCase2 = MySubscriptonIsExplorer
      break;
    case "Explorer":
      showSubscriptionIdontHaveCase1 =  MySubscriptonIsFlaner 
      showSubscriptionIdontHaveCase2 = MySubscriptonIsApprofondir
      break;
    case "Approfondir":
      showSubscriptionIdontHaveCase1 =  MySubscriptonIsFlaner  
      showSubscriptionIdontHaveCase2 = MySubscriptonIsExplorer
  ...
  return (
    <ScrollView style={styles.container} ref={refScrollView}>
      <Text h4 style={styles.text}>
       Je change d'abonnement
      </Text>

      <Text h4 style={styles.textTitle}>
        Choisir votre nouvel abonnement
      </Text>
      {/* <ScrollView> */}
        <View style={styles.viewCategorie}>

        
{showSubscriptionIdontHaveCase1}
{showSubscriptionIdontHaveCase2}
...
export default connect(mapStateToProps,null)(subscriptionChange);
